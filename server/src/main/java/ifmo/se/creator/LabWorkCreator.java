...
import ifmo.se.entity.Coordinates;
import ifmo.se.entity.Difficulty;
import ifmo.se.entity.LabWorkDto;
import ifmo.se.entity.Person;
import ifmo.se.exception.NonNullException;
import ifmo.se.exception.NonNullScriptException;
...
public class LabWorkCreator {
     ...
     */
    public LabWorkDto createLabWorkDto() {
