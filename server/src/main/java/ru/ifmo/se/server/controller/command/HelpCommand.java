...
public class HelpCommand extends AbstractCommand {
     ...
     */
    public HelpCommand(LabWorkService labWorkService, Map<String, String> descriptionMap) {
        super(labWorkService, CommandConfiguration.HELP_NAME, CommandConfiguration.HELP_DESCRIPTION);
